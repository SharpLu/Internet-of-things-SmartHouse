...
<title>Smart House Media Player Control System</title>
...
session.setAttribute("DevicesType", "MediaPlayer.jsp");
...
%>
	...
	<div class="main">
		<center>
			<form action="actionServlet" method="POST">
					...
					for (int i = 0; i < currentList.size(); i++) {
						if (currentList.get(i).contains(name)) {
							if (currentList.get(i).contains("ON")) {
								%>
					<img src="images/pl1.png" alt="not availible" width="150"height="150" id="image" /></br>			
				...
				<img src="images/pl2.png" alt="not availible" width="150"height="150" id="image" />	</br>				
								<%
							}
						}
					}
	...
	<script>
	    $(function() {
            var BV = new $.BigVideo();
			BV.init();
			BV.show('images/media.mp4',{ambient:true});
	    });
    </script>
</body>
</html>