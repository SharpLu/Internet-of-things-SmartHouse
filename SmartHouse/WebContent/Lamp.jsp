...
session.setAttribute("DevicesType", "Lamp.jsp");
...
%>
	...
	<div class="main">
		<center>
			<form action="actionServlet" method="POST">
					...
					for (int i = 0; i < currentList.size(); i++) {
						if (currentList.get(i).contains(name)) {
							if (currentList.get(i).contains("ON")) {
								%>
					<img src="images/lighton.png" alt="not availible" width="120"height="200" id="image" /></br>			
				...
				<img src="images/lightoff.png" alt="not availible" width="120"height="200" id="image" /></br>					
								<%
							}
						}
					}
	...
	<script>
	    $(function() {
            var BV = new $.BigVideo();
			BV.init();
			BV.show('images/Lamp.mp4',{ambient:true});
	    });
    </script>
</body>
</html>