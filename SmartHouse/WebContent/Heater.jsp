...
<title>Smart House Heater Control System</title>
...
session.setAttribute("DevicesType", "Heater.jsp");		
...
%>
	...
	<div class="main">
		<center>
			<form action="actionServlet" method="POST">
					...
					for (int i = 0; i < currentList.size(); i++) {
						if (currentList.get(i).contains(name)) {
							if (currentList.get(i).contains("ON")) {
								%>
					<img src="images/ht2.png" alt="not availible" width="220"height="150" id="image" /></br>			
				...
				<img  src="images/ht1.png" alt="not availible" width="220"height="150" id="image" /></br>	
	...
	<script>
	    $(function() {
            var BV = new $.BigVideo();
			BV.init();
			BV.show('images/heater.mp4',{ambient:true});
	    });
    </script>
</body>
</html>