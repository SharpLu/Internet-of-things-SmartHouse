...
<title>Smart House Temperature Control System</title>
...
session.setAttribute("DevicesType", "Temperature.jsp");
...
%>
	<div class="main">
		<center>
			...
			%>
			<img src="images/temrature.png" alt="not availible" width="320"height="160" id="image" /></br>		
			<% 
						}
					}
					currentList.clear();
	...
	<script>
	    $(function() {
            var BV = new $.BigVideo();
			BV.init();
			BV.show('images/temp.mp4',{ambient:true});
	    });
    </script>
</body>
</html>